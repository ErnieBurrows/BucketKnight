...
ABucketKnightCharacter::ABucketKnightCharacter()
{
...
void ABucketKnightCharacter::NotifyControllerChanged()
{
...
void ABucketKnightCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABucketKnightCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ABucketKnightCharacter::Look);
...
void ABucketKnightCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ABucketKnightCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
